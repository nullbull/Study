...
public class MovieLinkGrab {
    ...
    public static void main(String[] args) {
        MovieLinkGrab videoLinkGrab = new MovieLinkGrab();
        videoLinkGrab.saveData("http://www.banyungong.org/category/100-y-2018-a-0-mt-0.html");
    }
...
//              System.out.println(mapping.getKey() + " : " + mapping.getValue());
    ...
    public boolean checkUrl(String url){
        Pattern pattern =  Pattern.compile("http://www.banyungong.org/category/100-y-2018-a-0-mt-0.html\\d*");
    ...
    public boolean isMoviePage(String url){
        Pattern pattern =  Pattern.compile("http://www.banyungong.org/magnetm/\\d+");
        Matcher matcher = pattern.matcher(url);
        if(matcher.find())
            return true;  //电影页面
        else
